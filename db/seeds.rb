...
Tour.create!(account_id: 1, category_id: 1, title: 'Tour ngay 6/2 ', content: 'Tour ngay 6/2 Tour ngay 6/2 Tour ngay 6/2 Tour nga...', image: nil, avg_rate: 0.0, rate_amount: 0, price: 100_000, status: 'visible', start_day: '2020-02-06 00:00:00', end_day: '2020-02-08 00:00:00')

Tour.create!(account_id: 1, category_id: 1, title: 'tour ngay 10/2 ', content: 'tour ngay 10/2 tour ngay 10/2 tour ngay 10/2 tour ...', image: nil, avg_rate: 0.0, rate_amount: 0, price: 100_000, status: 'visible', start_day: '2020-02-10 00:00:00', end_day: '2020-02-13 00:00:00')

Tour.create!(account_id: 1, category_id: 2, title: 'tour thang 3 ', content: 'tour thang 3 tour thang 3 tour thang 3 tour thang ...', image: nil, avg_rate: 0.0, rate_amount: 0, price: 200_000, status: 'visible', start_day: '2020-03-06 00:00:00', end_day: '2020-03-06 00:00:00')

Tour.create!(account_id: 1, category_id: 1, title: 'tour 2019 ne ', content: 'tour 2019 ne tour 2019 ne tour 2019 ne tour 2019 n...', image: nil, avg_rate: 0.0, rate_amount: 0, price: 20_000, status: 'visible', start_day: '2019-02-06 00:00:00', end_day: '2019-02-06 00:00:00')

Tour.create!(account_id: 1, category_id: 1, title: 'tour thang 1 ', content: 'tour thang 1 tour thang 1 tour thang 1 tour thang ...', image: nil, avg_rate: 0.0, rate_amount: 0, price: 100_000, status: 'visible', start_day: '2020-01-06 00:00:00', end_day: '2020-01-06 00:00:00')
